module.exports = {
    ...
    switch (jmbg[5]) {
      ...
      return year+jmbg.substring(2,4)+jmbg.substring(0,2)
       ...
       console.log("HEMOLYZER 5  RESULT")
        segments.forEach(function (segment) {
            segment_type = segment.substring(0,3);
            //console.log('segment_type'+segment_type)
            switch (segment_type) {
                 case 'MSH':
                    console.log("MSH: ");
                  ...
                  case 'OBX':// Observation/Result            
                        ...
                        switch (obx[2]) {
                            ...
                            case "TX":
                                //console.log("TX")
                                //console.log("param:"+obx[3]+"  result:"+obx[5]+" unit:"+obx[6].split("$")[1])
                                  ...
                                  if (err) {
                                    ...
                                    if(rezultat){
                                      ...
                                      if(rezultat.multi.length){
                                        ...
                                        console.log("ne postoji navedeni SID"); 
                                    }
                                  }
                                })
                               }
